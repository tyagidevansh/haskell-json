...
main :: IO ()
main = do
  let jsonInput = "{\"name\": \"Alice\", \"age\": 30, \"isStudent\": false, \"hobbies\": [\"reading\", \"cycling\"]}"

  case runParser jsonValue jsonInput of
    Nothing -> putStrLn "Failed to parse JSON."
    Just ("", result) -> print result
    Just (leftover, result) -> do
      putStrLn "Parsed JSON successfully:"
      print result
      putStrLn "Leftover input:"
      print leftover
